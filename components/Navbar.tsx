        ...
        <nav className='fixed top-0 left-0 border-b border-white/5 bg-black/60  backdrop-blur-xl z-50'>
         <div className='mx-auto max-w-7xl px-6'>
            ...
            <div className='flex items-center space-x-3'>
                ...
                <span className='text-white font-semibold text-lg'>CrimeReport</span>
                </Link>
            ...
            <div className='hidden md:flex items-center space-x-6 '>
              ...
              <button className='group flex h-9 items-center gap-2 rounded-full bg-red-500/10 pl-4 pr-3 text-sm font-medium text-red-500 ring-1 ring-insert ring-red-500/20 transition-all hover:bg-red-500/20'>
